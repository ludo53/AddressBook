...
#[derive(Debug)]
pub struct AddressBookProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AddressBookProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AddressBook processing");
    
    let mut processor = AddressBookProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AddressBookProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AddressBookProcessor::new(false);
